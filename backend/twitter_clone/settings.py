...
ALLOWED_HOSTS = os.environ.get(
    ...
    "localhost,127.0.0.1,bookstore-2-w6ab.onrender.com"
).split(",")
...
CSRF_TRUSTED_ORIGINS = [
    ...
    "https://bookstore-2-w6ab.onrender.com",
]

CORS_ALLOW_ALL_ORIGINS = True  # ⚠️ Pode remover depois e deixar só os permitidos
